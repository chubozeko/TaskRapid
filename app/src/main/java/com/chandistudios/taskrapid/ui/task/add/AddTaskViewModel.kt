...
import com.chandistudios.taskrapid.ui.home.typeTask.formatToString
import com.chandistudios.taskrapid.ui.home.typeTask.toDateString
...
private fun createTaskAddedNotification(task: Task) {
    val notificationId = 2
    val builder = NotificationCompat.Builder(Graph.appContext, "CHANNEL_ID")
        .setSmallIcon(R.drawable.ic_launcher_background)
        .setContentTitle("New task added!")
        .setContentText("'${task.taskName}' is due on ${task.taskDate.toDateString()}")
